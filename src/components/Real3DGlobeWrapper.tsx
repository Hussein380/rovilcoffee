...
const Real3DGlobe = dynamic(() => import('./Real3DGlobe'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[320px] sm:h-[360px] max-w-[420px] mx-auto flex items-center justify-center relative rounded-2xl bg-gradient-to-b from-[#fbf9f6] to-[#f4ece4]/50 border border-[#d8c2b0]/40 overflow-hidden">

...
export default function OurFarmPage() {
  const [activeCropFilter, setActiveCropFilter] = useState<'all' | 'coffee' | 'tea'>('all');
  ...
  return (
    <div className="min-h-screen bg-white text-[#1f1610] flex flex-col font-sans">
      ...
      {/* 2. Hero Section with Real Macro Crop Photo & Ambient Glow */}
      <section className="relative min-h-[55vh] lg:min-h-[62vh] flex items-center justify-center overflow-hidden bg-[#180f08] text-white pt-16 pb-20">
        {/* Layer 0: Background Close-up Crop Image */}
        ...
        {/* Layer 1: Clean Gradient Scrim */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#180f08]/65 via-[#180f08]/45 to-[#180f08]/90 pointer-events-none z-1" />

        {/* Layer 4: Ambient Warm Glow Blobs */}
        <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-3 pt-2 text-center">
                <div className="p-3.5 rounded-2xl bg-white border border-[#ece3db] shadow-2xs">
                  <div className="text-xl sm:text-2xl font-extrabold text-[#23150c] font-mono">1,200+</div>
                  <div className="text-[11px] text-[#7a4727] font-semibold mt-0.5">Partner Farmers</div>
                </div>
                <div className="p-3.5 rounded-2xl bg-white border border-[#ece3db] shadow-2xs">
                  <div className="text-xl sm:text-2xl font-extrabold text-[#23150c] font-mono">2,100m</div>
                  <div className="text-[11px] text-[#7a4727] font-semibold mt-0.5">Peak Elevation</div>
                </div>
                <div className="p-3.5 rounded-2xl bg-white border border-[#ece3db] shadow-2xs">
                  <div className="text-xl sm:text-2xl font-extrabold text-[#23150c] font-mono">100%</div>
                  <div className="text-[11px] text-[#7a4727] font-semibold mt-0.5">Traceability</div>
                </div>
              </div>
            </div>

            {/* Macro Photo Card: Ripe Cherries */}
            <div className="lg:col-span-6 relative rounded-3xl overflow-hidden border border-[#ece3db] shadow-lg group">
              <div className="relative h-[380px] sm:h-[440px] w-full">
                <Image
                  src="/images/our-farm/ripe-coffee-cherries.jpg"
                  alt="Close-up of Ripe Crimson Arabica Coffee Cherries on Branch with Dew"
                  fill
                  unoptimized
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-white/30 shadow-md text-xs">
                <div className="flex items-center justify-between font-mono font-bold text-[#23150c]">
                  <span>KENYAN ARABICA (SL28 / SL34) CHERRY CLUSTER</span>
          ...
          <div className="space-y-6 pt-6">
            <div className="text-center max-w-2xl mx-auto space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#574c43]">
                Every bag exported by Rovil meets the most demanding statutory frameworks of Europe, North America, and East Asia.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-6 rounded-2xl bg-white border border-[#ece3db] space-y-3 shadow-xs">
                ...
                <p className="text-xs text-[#574c43] leading-relaxed">
                  Every participating farm plot has documented GPS boundary polygon coordinates confirming zero deforestation after December 31, 2020, complying fully with EU Regulation 2023/1115.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white border border-[#ece3db] space-y-3 shadow-xs">
                ...
                <h4 className="font-bold text-[#23150c] text-base">Native Shade Canopy Cultivation</h4>
                <p className="text-xs text-[#574c43] leading-relaxed">
                  Coffee trees are cultivated under indigenous African shade trees (Grevillea robusta, Cordia africana) to moderate equatorial sun, preserve soil moisture, and support biodiversity.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white border border-[#ece3db] space-y-3 shadow-xs">
                ...
                <h4 className="font-bold text-[#23150c] text-base">Clean Mountain Water Protection</h4>
                <p className="text-xs text-[#574c43] leading-relaxed">
                  Our wet mills utilize eco-pulpers that reduce water usage by 65%. Pulping runoff is directed through natural vetiver grass filtration lagoons to protect local river systems.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white border border-[#ece3db] space-y-3 shadow-xs">
                ...
                <h4 className="font-bold text-[#23150c] text-base">Zero Harmful Chemical Runoff</h4>
                <p className="text-xs text-[#574c43] leading-relaxed">
                  Adherence to strict Maximum Residue Limits (MRL) required by the EU and Japan Food Sanitation Act. Utilizing organic coffee pulp compost for soil replenishment.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-white border-b border-[#ece3db]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <span className="text-xs font-mono uppercase tracking-widest text-[#7a4727] font-semibold">
              Precision Agricultural Methodology
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {farmStages.map((stage) => (
              ...
              >
                ...
                <span className="absolute top-4 right-5 font-mono font-bold text-6xl opacity-[0.06] select-none pointer-events-none text-[#23150c]">
                  {stage.step}
                </span>

                <div className="relative z-10 space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="w-12 h-12 flex items-center justify-center rounded-2xl bg-[#23150c] text-white font-mono font-bold text-sm">
                      {stage.step}
                    </span>
                    <span className="px-3 py-1 rounded-full text-[10px] font-mono font-semibold bg-[#f4ece4] text-[#7a4727] border border-[#d8c2b0]">
                      {stage.durationOrSeason}
                    </span>
                  </div>

                  <div>
                    <h3 className="font-bold text-[#23150c] text-xl group-hover:text-[#7a4727] transition-colors duration-200">
                      {stage.title}
                    </h3>
                    <div className="flex items-center gap-1 text-xs text-[#7a4727] font-mono mt-1">
                  ...
                  <div className="pt-2 border-t border-[#ece3db] space-y-1.5 text-xs">
                    {stage.details.map((detail, idx) => (
                      <div key={idx} className="flex items-start gap-2">
                        ...
                        <span className="text-[#3e2211] text-[11px]">{detail}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      {/* 5. Authentic Crop Photography Gallery (Pure Macro Shots, Zero People) */}
      <section className="py-16 lg:py-24 bg-[#faf8f5] border-b border-[#ece3db]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <span className="text-xs font-mono uppercase tracking-widest text-[#7a4727] font-semibold">
                High-Definition Botanical Detail
              </span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#23150c]">
                Crop Close-Ups: Pure Kenyan Terroir
              </h2>
            </div>
            <p className="text-xs text-[#7d7065] font-mono max-w-md">
              Authentic macro photography of our coffee cherry clusters, sun-drying parchment, and highland tea flushes.
            </p>
          </div>
            ...
            <div className="group relative rounded-3xl overflow-hidden border border-[#ece3db] bg-white shadow-xs">
              ...
              <div className="p-5 space-y-1.5">
                <div className="flex items-center justify-between font-mono text-xs font-bold text-[#23150c]">
                  ...
                  <span className="text-red-700 bg-red-50 px-2 py-0.5 rounded text-[10px]">SL28 / SL34</span>
                </div>
                <p className="text-[#574c43] text-xs leading-relaxed">
                  Hand-plucked selectively when sugar Brix density peaks above 21%, ensuring maximum fruit sweetness and phosphoric clarity.
                </p>
              </div>
            </div>
            ...
            <div className="group relative rounded-3xl overflow-hidden border border-[#ece3db] bg-white shadow-xs">
              ...
              <div className="p-5 space-y-1.5">
                <div className="flex items-center justify-between font-mono text-xs font-bold text-[#23150c]">
                  ...
                  <span className="text-amber-700 bg-amber-50 px-2 py-0.5 rounded text-[10px]">10.5%–11.5% Moisture</span>
                </div>
                <p className="text-[#574c43] text-xs leading-relaxed">
                  Golden washed parchment spread on elevated wooden wire beds, turned continuously for 14–21 days under natural African sun.
                </p>
              </div>
            </div>
            ...
            <div className="group relative rounded-3xl overflow-hidden border border-[#ece3db] bg-white shadow-xs">
              ...
              <div className="p-5 space-y-1.5">
                <div className="flex items-center justify-between font-mono text-xs font-bold text-[#23150c]">
                  ...
                  <span className="text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded text-[10px]">Prime Flush</span>
                </div>
                <p className="text-[#574c43] text-xs leading-relaxed">
                  Only the tender apical bud and two uppermost leaves are selected, delivering world-renowned briskness and golden liquor.
                </p>
              </div>
            </div>
            ...
            <div className="group relative rounded-3xl overflow-hidden border border-[#ece3db] bg-white shadow-xs">
              ...
              <div className="p-5 space-y-1.5">
                <div className="flex items-center justify-between font-mono text-xs font-bold text-[#23150c]">
                  ...
                  <span className="text-purple-700 bg-purple-50 px-2 py-0.5 rounded text-[10px]">TRFK 306 Cultivar</span>
                </div>
                <p className="text-[#574c43] text-xs leading-relaxed">
                  Grown above 2,100 meters where high UV radiation prompts rich natural anthocyanins, creating a rare violet wellness infusion.
                </p>
              </div>
            </div>
      ...
      {/* 6. Farm Visit & Pre-Shipment Sample CTA Banner */}
